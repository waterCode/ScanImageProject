package com.meitu.scanimageview.util;
...
public class ImageLoadUtil {
    ...
    public static BitmapFactory.Options calculateInSampleSize(ContentResolver contentResolver, Uri uri, int maxHeight, int maxWidth) throws IOException {
